...
declare module '@nuxt/schema' {
  interface ModuleDependencies {
    ["@kevinmarrec/nuxt-pwa"]?: ModuleDependencyMeta<typeof import("@kevinmarrec/nuxt-pwa").default extends NuxtModule<infer O> ? O : Record<string, unknown>>
  ...
  interface NuxtOptions {
     ...
     */
    ["pwa"]: typeof import("@kevinmarrec/nuxt-pwa").default extends NuxtModule<infer O, unknown, boolean> ? O : Record<string, any>
    /**
  ...
  interface NuxtConfig {
     ...
     * Configuration for `@kevinmarrec/nuxt-pwa`
     */
    ["pwa"]?: typeof import("@kevinmarrec/nuxt-pwa").default extends NuxtModule<infer O, unknown, boolean> ? Partial<O> : Record<string, any>
    /**
     * Configuration for `@nuxtjs/tailwindcss`
     */
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["@kevinmarrec/nuxt-pwa", Exclude<NuxtConfig["pwa"], boolean>] | ["@nuxtjs/tailwindcss", Exclude<NuxtConfig["tailwindcss"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["nuxt-icon", Exclude<NuxtConfig["icon"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface ModuleDependencies {
